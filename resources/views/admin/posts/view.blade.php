							...
							@foreach($posts as $post)
								<tr style="text-align: center;">
									...
									<td style="vertical-align: middle;">
										<a href="/admin/posts/edit/{{ $post->id }}" class="genric-btn info rounded small">Edit</a>
										<button id="{{ $post->id}}" class="genric-btn delete_post_button danger rounded small">Delete</button>
									</td>
								</tr>
							@endforeach	
						</tbody>
					...
					<div class="well">
						...
						<div class="row">
							<div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-12 col-12">
								<a href="/admin/posts/new" class="genric-btn primary">New Blog Post</a>
							</div>
						</div>
					</div>
				</div>
